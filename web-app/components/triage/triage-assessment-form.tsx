...
export function TriageAssessmentForm({
  ...
  const {
    ...
    defaultValues: {
      arrival_mode: initialData?.arrival_mode || undefined,
      arrival_time: initialData?.arrival_time || new Date().toISOString().slice(0, 16),
      chief_complaint_category: initialData?.chief_complaint_category || undefined,
      chief_complaint: initialData?.chief_complaint || '',
      pain_score: initialData?.pain_score ?? null,
      mental_status: initialData?.mental_status || undefined,
      mobility: initialData?.mobility || undefined,
      allergies_noted: initialData?.allergies_noted || patient.allergies || '',
      triage_category: initialData?.triage_category || undefined,
      ...
      assigned_area: initialData?.assigned_area || undefined,
