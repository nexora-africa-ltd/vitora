...
export function PaymentForm({
  ...
  const invoiceMeta = invoice as InvoicePaymentMeta;
  const isInsuranceOrSHAInvoice = Boolean(
    String(invoiceMeta.payer_type || '').toLowerCase() === 'sha' ||
    String(invoiceMeta.payment_type || '').toLowerCase() === 'insurance' ||
    !!invoiceMeta.sha_claim_number
  );
  ...
  const cashChange =
    watchedMethod === 'CASH' && watchedCashReceived
  ...
  return (
    <Form {...form}>
      <form
        ...
        className="flex max-h-[calc(80vh-8rem)] flex-col"
      >
                    ...
                    <CardContent>
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        <div>
                          ...
                          <span className="ml-2 font-medium">{formatCurrency(grossTotal)}</span>
                        </div>
                        <div>
                    ...
                    >
                      {[
                        ...
                        { value: 'CARD' as const, label: 'Card', icon: paymentMethodIcons.CARD },
                        {
                          ...
                          label: 'Bank Transfer',
                          icon: paymentMethodIcons.BANK_TRANSFER,
                        },
                      ].map((method) => {
                        const isDisabled =
                          isInsuranceOrSHAInvoice && method.value !== 'BANK_TRANSFER';
                        return (
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>Maximum: {formatCurrency(payableBalance)}</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          {!verificationResult && (
                            <FormDescription>
                              Enter the code from the patient&apos;s M-Pesa confirmation SMS and
                              verify it
                            </FormDescription>
                          )}
                          <FormMessage />
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>Optional — for record-keeping</FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                    />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input inputMode="numeric" placeholder="1234" maxLength={4} {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                {cashChange > 0 && (
                  <Alert>
                    <AlertDescription className="flex items-center justify-between">
                      <span>Change</span>
                      <span className="text-lg font-bold" data-testid="cash-change">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="Add any payment notes..." {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
