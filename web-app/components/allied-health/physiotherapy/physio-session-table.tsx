...
import type { PhysiotherapySessionListItem } from '@/lib/types/physiotherapy';
import { useToast } from '@/lib/hooks/use-toast';

interface PhysioSessionTableProps {
  sessions: PhysiotherapySessionListItem[];
  orderId: number;
}

export function PhysioSessionTable({ sessions, orderId }: PhysioSessionTableProps) {
