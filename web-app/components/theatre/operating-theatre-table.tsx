    ...
    <ResponsiveTable
      ...
      columns={[
        ...
        },
        {
          ...
          cell: (theatre) =>
            formatTheatreHours(theatre.operating_hours_start, theatre.operating_hours_end),
          hideOnMobile: true,
        },
        {
        ...
        <Card className="p-3">
          <div className="flex items-start justify-between gap-3">
            <div className="min-w-0">
              ...
              <p className="text-sm text-muted-foreground">
                {theatre.code} • {THEATRE_TYPE_LABELS[theatre.theatre_type]}
              </p>
              <p className="text-xs text-muted-foreground">
                {theatre.location || 'No location'} •{' '}
                {formatTheatreHours(theatre.operating_hours_start, theatre.operating_hours_end)}
              </p>
            </div>
          ...
          <div className="mt-3 flex items-center justify-between">
            <span className="text-xs text-muted-foreground">
              Slots: {theatre.slot_duration_minutes} min
            </span>
            <div className="flex items-center gap-2">
              <Button type="button" size="sm" variant="outline" onClick={() => onEdit(theatre)}>
                Edit
              </Button>
              <Button
                type="button"
