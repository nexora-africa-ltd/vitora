  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <DialogTitle>
            {editingId ? 'Edit Operating Theatre' : 'Create Operating Theatre'}
          </DialogTitle>
        </DialogHeader>
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="Operating Theatre 1"
            />
          ...
          <div className="space-y-2">
            ...
            <Select
              value={form.theatre_type}
              onValueChange={(value) => onFieldChange('theatre_type', value as TheatreType)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Input
              id="hours-start"
              type="time"
              value={form.operating_hours_start || '08:00'}
              onChange={(event) => onFieldChange('operating_hours_start', event.target.value)}
            />
          </div>
          <div className="space-y-2">
            ...
            <Input
              id="hours-end"
              type="time"
              value={form.operating_hours_end || '18:00'}
              onChange={(event) => onFieldChange('operating_hours_end', event.target.value)}
            />
          </div>
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(event) =>
                onFieldChange('slot_duration_minutes', Number(event.target.value) || 30)
              }
            />
          </div>
            ...
            <div className="flex items-center justify-between gap-3">
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Inactive theatres keep their scheduling resource but are excluded from active use.
                </p>
              </div>
              <Switch
          ...
          <div className="space-y-3 rounded-lg border p-3">
            <div className="flex items-center justify-between gap-3">
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Mark this if the theatre is equipped for laminar-flow procedures.
                </p>
              </div>
              <Switch
                checked={form.has_laminar_flow ?? false}
                onCheckedChange={(checked) => onFieldChange('has_laminar_flow', checked)}
              />
            </div>
          </div>
          <div className="space-y-3 rounded-lg border p-3">
            <div className="flex items-center justify-between gap-3">
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Use this for hybrid or interventional rooms with cath-lab capability.
                </p>
              </div>
              <Switch
                checked={form.has_cath_lab ?? false}
                onCheckedChange={(checked) => onFieldChange('has_cath_lab', checked)}
              />
            </div>
          </div>
          <div className="space-y-3 rounded-lg border p-3">
            <div className="flex items-center justify-between gap-3">
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Enable for theatres that support intra-operative fluoroscopy or C-arm workflows.
                </p>
              </div>
              <Switch
                checked={form.has_image_intensifier ?? false}
                onCheckedChange={(checked) => onFieldChange('has_image_intensifier', checked)}
              />
            </div>
          </div>
          <div className="space-y-2 sm:col-span-2">
            ...
            <Textarea
              ...
              placeholder="Microscope, arthroscopy tower, anesthesia workstation..."
            />
          </div>
          <div className="space-y-2 sm:col-span-2">
            ...
            <Textarea
              ...
              onChange={(event) => onFieldChange('maintenance_notes', event.target.value)}
              placeholder="Recent service window, known limitations, preventive maintenance notes..."
            />
          </div>
        </div>
        ...
        <div className="grid gap-3 rounded-lg border bg-muted/30 p-4 sm:grid-cols-3">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Saving updates the linked scheduling PLACE resource automatically.
              </p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Working hours are mirrored to recurring scheduling slots for all seven days.
              </p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Theatre booking uses the scheduling resource once the sync is in place.
              </p>
            </div>
          </div>
        </div>
