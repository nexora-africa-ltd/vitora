...
import { Building2, Activity, Clock, ChevronRight, RefreshCw } from 'lucide-react';
...
export function ClinicTypePage({ title, description, clinicTypes, icon }: ClinicTypePageProps) {
  ...
  const clinics = useMemo(() => {
    ...
    return data.results.filter((clinic) => clinicTypes.includes(clinic.clinic_type));
        ...
        {isLoading ? (
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-12">
              ...
              <h3 className="mb-2 text-lg font-semibold">No clinics found</h3>
