    ...
    <Card className={className}>
      <CardHeader className="flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-2">
          <div>
            ...
            <CardDescription>Ward compatibility override statistics</CardDescription>
          </div>
          <HelpPopover content="Statistics on ward constraint overrides during admissions. Tracks violations by type and ward to identify patterns." />
        </div>
      ...
      <CardContent className="space-y-6">
        ...
        {metrics.common_reasons.length > 0 && (
          <div>
            <h4 className="font-medium mb-3">Common Override Reasons</h4>
