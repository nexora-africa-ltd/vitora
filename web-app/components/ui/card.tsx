  ...
  'rounded-xl border bg-card text-card-foreground shadow transition-all duration-200',
  {
    variants: {
      variant: {
        ...
        elevated: 'shadow-md hover:shadow-xl hover:translate-y-[-2px]',
        outline: 'border-2 hover:border-primary/50 hover:shadow-sm',
        dashed:
        ...
        muted: 'bg-muted/50 border-muted/40 shadow-none hover:bg-muted/60',
        accent:
