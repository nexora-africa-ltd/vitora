...
const PanelGroupPrimitive =
  (ResizablePrimitive as any).PanelGroup ?? (ResizablePrimitive as any).ResizablePanelGroup

const PanelPrimitive =
  (ResizablePrimitive as any).Panel ?? (ResizablePrimitive as any).ResizablePanel

const PanelResizeHandlePrimitive =
  (ResizablePrimitive as any).PanelResizeHandle ??
  (ResizablePrimitive as any).ResizablePanelResizeHandle ??
  (ResizablePrimitive as any).ResizableHandle
