...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-evenly rounded-md bg-teal-400/10 p-1 text-muted-foreground/shadow-sm",
      className
    )}
    {...props}
  />
    ...
    <button
      ...
      className={cn(
        ...
        isActive
          ...
          : "hover:bg-teal-400/50 hover:text-foreground hover:shadow-sm",
        className
      )}
