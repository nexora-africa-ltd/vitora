...
>(({ className, value, onClick, ...props }, ref) => {
  ...
  return (
    <button
      ...
      {...props}
      className={cn(
        'inline-flex cursor-pointer items-center justify-evenly whitespace-nowrap rounded-sm px-3 py-1.5 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
        isActive
          ? 'animate-pulse-text bg-transparent text-xl font-semibold text-foreground shadow-sm '
