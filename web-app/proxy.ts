 ...
 */
const PUBLIC_ROUTES = ['/login', '/forgot-password', '/reset-password', '/invite', '/change-password', '/signup', '/verify-email', '/verify', '/setup', '/imaging/share', '/queue-display', '/triage-display'];
