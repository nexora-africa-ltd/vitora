/**
 * Occupational Therapy Sessions List Page
 * View all OT sessions with filtering and status management
 */
...
import type { OTSessionListParams } from '@/lib/types/occupational-therapy';
...
export default function OccupationalTherapySessionsPage() {
  ...
  // Build query params
  const params: OTSessionListParams = {
    page,
    page_size: 20,
  ...
  const { data, isLoading, error } = useOTSessions(params);
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        helpContent="View and manage all occupational therapy treatment sessions. Filter by date, status, or search for specific patients."
      />
        ...
        <CardContent className="p-0">
          {isLoading ? (
            ...
            <EmptyState
              ...
              description="No OT sessions match your filters. Try adjusting the date range or status filter."
            />
          ) : (
            <>
              <Table>
                  ...
                  {sessions.map((session) => {
                    ...
                    return (
                      <TableRow
                        ...
                        onClick={() => router.push(`/allied-health/occupational-therapy/orders/${session.order_number.split('-')[0]}`)}
                      >
