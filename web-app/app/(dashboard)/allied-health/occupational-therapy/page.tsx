/**
 * Occupational Therapy Module Dashboard Page
...
export default function OccupationalTherapyDashboardPage() {
  ...
  const otStats = dashboardStats?.occupational_therapy;
  const queueStats = dashboardStats?.clinic_queue_stats?.ot;
      ...
      <PageHeader
        ...
        actions={
          <Button
            ...
            disabled={!canCreateRoute('/allied-health/occupational-therapy/orders/new')}
          >
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-yellow-600">
              {statsLoading ? '...' : otStats?.pending_count || 0}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-blue-600">
              {statsLoading ? '...' : otStats?.today_sessions_count || 0}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-600">
              {statsLoading ? '...' : otStats?.completed_today_count || 0}
            </div>
            ...
            <CardContent>
              {queueLoading ? (
                ...
                <EmptyState
                  ...
                  description="No patients are currently checked into the OT Clinic."
                />
              ) : (
