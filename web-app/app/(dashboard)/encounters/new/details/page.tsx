...
import { CHIEF_COMPLAINT_CONFIG, type ChiefComplaintCategory } from '@/lib/types/triage';
...
export default function NewEncounterDetailsPage() {
  ...
  const encounterTypeLabel =
    ENCOUNTER_TYPES.find((t) => t.value === details.encounter_type)?.label ??
    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <Card>
        <CardHeader className="px-3 py-3 sm:px-6 sm:py-4">
          ...
          <CardDescription>Describe what brings the patient in today.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4 px-3 sm:px-6">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            ...
            <div className="space-y-2">
              <Label htmlFor="encounter_date">
                Date <span className="text-xs text-muted-foreground">(today)</span>
              </Label>
              <Input
                id="encounter_date"
                type="date"
          ...
          <div className="space-y-2">
            <Label htmlFor="chief_complaint_category">Complaint Category</Label>
            <Select
              value={details.chief_complaint_category || undefined}
              onValueChange={(value) => handleFieldChange('chief_complaint_category', value)}
            >
