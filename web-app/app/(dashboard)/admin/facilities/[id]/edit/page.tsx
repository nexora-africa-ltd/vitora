...
const MODULE_LABELS: { key: string; label: string }[] = [
  ...
  { key: 'has_hdu', label: 'HDU' },
  { key: 'has_nbu', label: 'NBU' },
  ...
  { key: 'has_pharmacy_standalone', label: 'Pharmacy Standalone' },
  { key: 'has_imaging_standalone', label: 'Imaging Standalone' },
...
export default function EditFacilityPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    has_pharmacy_standalone: false,
    has_imaging_standalone: false,
    has_triage: true,
    has_scheduling: true,
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const payload: FacilityUpdateData = {
      ...
      has_hdu: formData.has_hdu,
      has_nbu: formData.has_nbu,
      ...
      has_pharmacy_standalone: formData.has_pharmacy_standalone,
      has_imaging_standalone: formData.has_imaging_standalone,
