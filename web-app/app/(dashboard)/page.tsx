  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Welcome to Vitora HMIS</p>
      </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-2">
          <Button className="w-full justify-start" variant="outline" onClick={() => router.push('/patients')}>
            <Users className="mr-2 h-4 w-4" />
            View All Patients
          </Button>
          <Button className="w-full justify-start" variant="outline" onClick={() => router.push('/patients/new')}>
            <Users className="mr-2 h-4 w-4" />
