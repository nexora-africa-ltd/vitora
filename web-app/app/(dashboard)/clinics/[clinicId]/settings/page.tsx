...
export default function ClinicSettingsPage() {
  ...
  const availableClinics = (allClinicsData?.results ?? []).filter((c) => c.id !== clinicId);
  ...
  const updateEligibilityField = useCallback(
    <K extends keyof ClinicEligibilityRules>(key: K, value: ClinicEligibilityRules[K]) => {
  ...
  const saveEligibility = useCallback(async () => {
    ...
    if (eligibility.min_age !== undefined && eligibility.min_age !== null)
      cleaned.min_age = eligibility.min_age;
    if (eligibility.max_age !== undefined && eligibility.max_age !== null)
      cleaned.max_age = eligibility.max_age;
    ...
    if (eligibility.conditions && eligibility.conditions.length > 0)
      cleaned.conditions = eligibility.conditions;
    if (eligibility.required_enrollments && eligibility.required_enrollments.length > 0)
      cleaned.required_enrollments = eligibility.required_enrollments;
        ...
        <Tabs defaultValue="general" className="space-y-4">
          ...
          <TabsContent value="general" className="space-y-4">
            ...
            <Card>
              ...
              <CardContent className="space-y-3 p-3 pt-0 sm:space-y-4 sm:p-6">
                <div className="grid gap-3 sm:grid-cols-2 sm:gap-4">
          ...
          <TabsContent value="schedule" className="space-y-4">
            <Card>
              ...
              <CardContent className="p-0 sm:p-6 sm:pt-0">
                {scheduleLoading ? (
                  <Skeleton className="sm:mx-0\ mx-3 h-32 sm:h-48" />
                  ...
                  <div className="flex flex-col items-center justify-center py-6 text-center sm:py-8">
                    ...
                    <h3 className="mb-2 text-sm font-semibold sm:text-base">No schedule</h3>
                  ...
                  <>
                    ...
                    <div className="space-y-2 px-3 pb-3 sm:hidden">
                      {schedule.map((entry) => (
                        ...
                        >
                          <div>
                            <span className="text-sm font-medium">{entry.day_display}</span>
          ...
          <TabsContent value="staff" className="space-y-4">
            <Card>
              ...
              <CardContent className="p-0 sm:p-6 sm:pt-0">
                {staffLoading ? (
                  <Skeleton className="mx-3 h-32 sm:mx-0 sm:h-48" />
                ) : !staff || staff.length === 0 ? (
                  <div className="flex flex-col items-center justify-center py-6 text-center sm:py-8">
                    <Users className="mb-4 h-10 w-10 text-muted-foreground sm:h-12 sm:w-12" />
                    <h3 className="mb-2 text-sm font-semibold sm:text-base">No staff</h3>
                    <Button size="sm" asChild>
            ...
            <Card>
              ...
              <CardContent className="space-y-4 p-3 pt-0 sm:space-y-6 sm:p-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Select which genders are eligible. Leave all unchecked for no restriction.
                  </p>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Conditions a patient must have to be eligible for this clinic.
                  </p>
                  ...
                  {(eligibility.conditions ?? []).filter(
                    (c) => !COMMON_CONDITIONS.includes(c as (typeof COMMON_CONDITIONS)[number])
                  ).length > 0 && (
                    <div className="mt-1 flex flex-wrap gap-1.5">
                      {eligibility
                        .conditions!.filter(
                          (c) =>
                            !COMMON_CONDITIONS.includes(c as (typeof COMMON_CONDITIONS)[number])
                        )
                        .map((condition) => {
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Patient must be enrolled in these clinics/programs to be eligible.
                  </p>
                  <Select value="" onValueChange={(code) => addEnrollment(code)}>
                ...
                {!eligibilityDirty && !clinic.eligibility_rules && (
                  <div className="rounded-lg border border-dashed p-4 text-center">
                    ...
                    <p className="text-sm text-muted-foreground">
                      No eligibility restrictions configured. All patients are eligible for this
                      clinic.
                    </p>
                  </div>
                )}
