...
import { Loader2, Sun, Moon, AlertCircle, CheckCircle2, ShieldCheck } from 'lucide-react';
        ...
        {state === 'success' && (
          <CardContent className="relative z-10 flex flex-col items-center justify-center gap-4 py-16">
            ...
            <div className="max-w-xs space-y-2 text-center">
              ...
              <p className="text-sm text-muted-foreground">
                A Nexora administrator will review and activate your organization. You&apos;ll
