    ...
    <div className="flex min-h-screen items-center justify-center bg-muted/20 px-4 py-10">
      <div className="w-full max-w-lg rounded-2xl border border-border/60 bg-background px-8 py-10 text-center shadow-lg">
        ...
        <VitoraLogo
          tone="light"
          alt="Vitora HMIS"
          className="mx-auto hidden w-44 dark:block"
          priority
        />
        <div className="dark:bg-brand-teal-950/30 mx-auto mt-6 flex h-16 w-16 items-center justify-center rounded-full bg-brand-teal-50 text-brand-teal-700 dark:text-brand-teal-300">
