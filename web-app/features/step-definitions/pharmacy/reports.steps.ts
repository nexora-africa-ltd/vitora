...
When('I select report period {string}', async function (this: VitoraWorld, period: string) {
...
When('I generate the dispensing report', async function (this: VitoraWorld) {
  ...
  if (this.page) {
    await this.page.click(
      '[data-testid="generate-dispensing-report"], button:has-text("Generate")'
    );
    await this.page.waitForTimeout(300);
  }
});

When('I generate a dispensing report for today', async function (this: VitoraWorld) {
...
Given('expiry report is generated', async function (this: VitoraWorld) {
  this.store('expiryReportGenerated', true);
});

When('I generate a stock summary report', async function (this: VitoraWorld) {
...
When('I view stock summary by category', async function (this: VitoraWorld) {
  this.store('stockSummaryView', 'category');
});

When('I view stock summary by drug schedule', async function (this: VitoraWorld) {
...
Then('data should be aggregated appropriately', async function (this: VitoraWorld) {
...
Then('I should see breakdown:', async function (this: VitoraWorld, dataTable: DataTable) {
...
Then('I should see summary counts:', async function (this: VitoraWorld, dataTable: DataTable) {
  const rows = dataTable.hashes();
