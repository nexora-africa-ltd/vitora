...
Given('the database has 100,000+ patients', async function (this: VitoraWorld) {
  this.store('patientDbSize', 100_000);
});

Given('I find patient {string} in search', async function (this: VitoraWorld, patientName: string) {
...
When('I view search results', async function (this: VitoraWorld) {
...
When('I view the search results', async function (this: VitoraWorld) {
  this.store('viewingSearchResults', true);
  if (this.page) {
    await this.page.goto('/patients/search');
    await this.page.waitForLoadState('networkidle');
...
When("I view a patient's record", async function (this: VitoraWorld) {
