...
Given('I am offline', async function (this: VitoraWorld) {
...
Given('I am now offline', async function (this: VitoraWorld) {
  this.store('offline', true);
  if (this.context) {
    await this.context.setOffline(true);
  }
...
Then('it should be accepted', async function (this: VitoraWorld) {
