...
Given('I am on the {string} page', async function (this: VitoraWorld, pageName: string) {
...
Given('I am on the patient registration page', async function (this: VitoraWorld) {
...
Given('I am on the outpatient department page', async function (this: VitoraWorld) {
...
Given('I am on the inpatient department page', async function (this: VitoraWorld) {
...
Given('I am on the pharmacy alerts dashboard', async function (this: VitoraWorld) {
...
Given('I am on the pharmacy reports page', async function (this: VitoraWorld) {
...
Given('I am on the triage reports dashboard', async function (this: VitoraWorld) {
...
Given('I am on the pharmacy dispensing screen', async function (this: VitoraWorld) {
...
Given('I am on the queue management page', async function (this: VitoraWorld) {
...
When('I navigate to the {string} page', async function (this: VitoraWorld, pageName: string) {
  const normalizedPage = pageName.toLowerCase();
  const url = PAGE_URLS[normalizedPage];
...
When('I click on {string} in the sidebar', async function (this: VitoraWorld, menuItem: string) {
  if (this.page) {
...
When('I go back', async function (this: VitoraWorld) {
  if (this.page) {
    await this.page.goBack();
  }
});

When('I refresh the page', async function (this: VitoraWorld) {
  if (this.page) {
...
Then('I should be on the {string} page', async function (this: VitoraWorld, pageName: string) {
  const normalizedPage = pageName.toLowerCase();
...
Then('I should see the page title {string}', async function (this: VitoraWorld, title: string) {
  if (this.page) {
    await expect(this.page).toHaveTitle(new RegExp(title, 'i'));
  }
});

Then('I should see heading {string}', async function (this: VitoraWorld, heading: string) {
  if (this.page) {
...
Then('the URL should contain {string}', async function (this: VitoraWorld, urlPart: string) {
  if (this.page) {
    await expect(this.page).toHaveURL(new RegExp(urlPart));
  }
});

Then('I should see a loading indicator', async function (this: VitoraWorld) {
  if (this.page) {
