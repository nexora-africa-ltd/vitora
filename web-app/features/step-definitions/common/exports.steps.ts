...
Given('a report is generated', async function (this: VitoraWorld) {
  this.store('reportGenerated', true);
});

Then('a CSV file should be downloaded', async function (this: VitoraWorld) {
...
Then('an Excel file should be downloaded with:', async function (this: VitoraWorld) {
  this.store('excelDownloaded', true);
});

Then('a PDF should be generated with:', async function (this: VitoraWorld) {
  this.store('pdfGenerated', true);
});

When('I select date range {string}', async function (this: VitoraWorld, range: string) {
