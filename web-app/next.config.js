...
const nextConfig = {
  ...
  async headers() {
    return [
      ...
      {
        source: '/laboratory/results/:path*',
        headers: [
          {
            key: 'X-Frame-Options',
            value: 'SAMEORIGIN',
      ...
      {
        source: '/laboratory/reports/:path*',
        headers: [
          {
            key: 'X-Frame-Options',
            value: 'SAMEORIGIN',
      ...
      {
        source: '/pharmacy/prescriptions/:path*',
        headers: [
          {
            key: 'X-Frame-Options',
            value: 'SAMEORIGIN',
      ...
      {
        source: '/transactions/invoices/:path*',
        headers: [
          {
            key: 'X-Frame-Options',
            value: 'SAMEORIGIN',
      ...
      {
        source: '/transactions/sha-claims/:path*',
        headers: [
          {
            key: 'X-Frame-Options',
            value: 'SAMEORIGIN',
      ...
      {
        source: '/transactions/preauths/:path*',
        headers: [
          {
            key: 'X-Frame-Options',
            value: 'SAMEORIGIN',
      ...
      {
        source: '/transactions/credit-notes/:path*',
        headers: [
          {
            key: 'X-Frame-Options',
            value: 'SAMEORIGIN',
      ...
      {
        source: '/transactions/receipts/:path*',
        headers: [
          {
            key: 'X-Frame-Options',
            value: 'SAMEORIGIN',
      ...
      {
        source: '/transactions/payments/:path*',
        headers: [
          {
            key: 'X-Frame-Options',
            value: 'SAMEORIGIN',
      ...
      {
        source: '/document-hub/sha-attachments/:path*',
        headers: [
          {
            key: 'X-Frame-Options',
            value: 'SAMEORIGIN',
...
if (enableSentryBuildPlugin) {
  module.exports = withSentryConfig(module.exports, {
    ...
    // Keep wide uploads for production release diagnostics only.
