...
export const ACTION_PERMISSIONS = {
  ...
  'imaging.manage_equipment': ['RADIOGRAPHER', 'RADIOLOGIST', 'ADMIN'],
  ...
  'inventory.initiate_stock_count': ['ADMIN', 'ORG-ADMIN', 'PHARMACIST', 'STORE_KEEPER'],
  'inventory.record_stock_count': ['ADMIN', 'ORG-ADMIN', 'PHARMACIST', 'PHARMACY_TECH', 'STORE_KEEPER'],
  'inventory.cancel_stock_count': ['ADMIN'],
