...
import { OrgJoinRequestSchema, PaginatedJoinRequestSchema } from '@/lib/schemas/membership.schema';
...
export const joinRequestsApi = {
  ...
  list: async (params?: JoinRequestListParams): Promise<PaginatedResponse<OrgJoinRequest>> => {
    ...
    return parseResponse(PaginatedJoinRequestSchema, response.data, {
      context: 'joinRequestsApi.list',
    });
  },
  ...
  create: async (data: JoinRequestCreateData): Promise<OrgJoinRequest> => {
    ...
    return parseResponse(OrgJoinRequestSchema, response.data, {
      context: 'joinRequestsApi.create',
    });
  },
  ...
  approve: async (id: number, data: JoinRequestApproveData): Promise<OrgJoinRequest> => {
    ...
    return parseResponse(OrgJoinRequestSchema, response.data, {
      context: 'joinRequestsApi.approve',
    });
  },
  ...
  reject: async (id: number, data?: JoinRequestRejectData): Promise<OrgJoinRequest> => {
    ...
    return parseResponse(OrgJoinRequestSchema, response.data, {
      context: 'joinRequestsApi.reject',
    });
  },
  ...
  cancel: async (id: number): Promise<{ message: string }> => {
    ...
    return parseResponse(MessageResponseSchema, response.data, {
      context: 'joinRequestsApi.cancel',
    });
  },
};
