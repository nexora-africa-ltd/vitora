...
import { ENABLE_THEATRE, ENABLE_AI } from '@/lib/utils/constants';
...
const _allNavItems: NavItemType[] = [
  { label: 'Dashboard', href: '/', icon: LayoutDashboard, moduleKey: 'dashboard' },
  {
    ...
    href: '/document-hub',
    icon: FileText,
    actionKey: 'core.view_document_hub',
  },
  {
    label: 'Clinics & ER Check-in',
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'New Triage', href: '/triage/new', icon: Thermometer, actionKey: 'triage.assess' },
      {
        ...
        href: '/triage/reports',
        icon: BarChart3,
        actionKey: 'triage.view_reports',
      },
      {
        label: 'Settings',
        href: '/triage/settings',
        icon: Settings,
        actionKey: 'triage.manage_settings',
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        actionKey: 'emergency.view_dashboard',
      },
      {
        label: 'Bed Board',
        href: '/emergency/bed-board',
        icon: BedDouble,
        actionKey: 'emergency.view_bed_board',
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        icon: UserPlus2,
        actionKey: 'scheduling.create_appointment',
      },
      {
        label: 'Schedules',
        href: '/scheduling/schedules',
        icon: Clock,
        actionKey: 'scheduling.view_schedules',
      },
      {
        label: 'Resources',
    ...
    children: [
      {
        ...
        href: '/surveillance',
        icon: LayoutDashboard,
        actionKey: 'surveillance.view_dashboard',
      },
      {
        label: 'Notifiable Cases',
        href: '/surveillance/cases',
        icon: AlertTriangle,
        actionKey: 'surveillance.report_case',
      },
      {
        label: 'Alerts',
        href: '/surveillance/alerts',
        icon: CircleAlert,
        actionKey: 'surveillance.view_alerts',
      },
      {
        label: 'IDSR Reports',
        href: '/surveillance/idsr',
        icon: BarChart3,
        actionKey: 'surveillance.submit_idsr',
        requiresInternet: true,
      },
      {
        label: 'IHR Compliance',
        href: '/surveillance/ihr',
        icon: Globe,
        actionKey: 'surveillance.submit_ihr',
        requiresInternet: true,
      },
      {
        label: 'Thresholds',
        ...
        icon: SquareActivity,
        actionKey: 'surveillance.manage_thresholds',
      },
    ],
  },
  {
    ...
    children: [
      ...
      {
        label: 'General OPD',
        href: '/clinics/general-opd',
        icon: StethoscopeIcon,
        visibleWhen: ({ activeClinicTypes }) =>
          !activeClinicTypes ||
          activeClinicTypes.has('GENERAL_OPD') ||
          activeClinicTypes.has('FILTER_CLINIC'),
      },
      {
        label: 'MCH / Welfare',
        href: '/clinics/mch',
        icon: Baby,
        visibleWhen: ({ activeClinicTypes }) =>
          !activeClinicTypes || ['ANC', 'PNC', 'FP', 'CWC'].some((t) => activeClinicTypes.has(t)),
      },
      {
        label: 'Eye Clinic',
        href: '/clinics/eye',
        icon: Eye,
        visibleWhen: ({ activeClinicTypes }) => !activeClinicTypes || activeClinicTypes.has('EYE'),
      },
      {
        label: 'Dental Clinic',
        href: '/clinics/dental',
        icon: Activity,
        visibleWhen: ({ activeClinicTypes }) =>
          !activeClinicTypes || activeClinicTypes.has('DENTAL'),
      },
      {
        label: 'Surgical Clinic',
        href: '/clinics/surgical',
        icon: Scissors,
        visibleWhen: ({ activeClinicTypes }) =>
          !activeClinicTypes || activeClinicTypes.has('SURGICAL'),
      },
      {
        label: 'Chronic Care',
        href: '/clinics/chronic-care',
        icon: HeartPulse,
        visibleWhen: ({ activeClinicTypes }) =>
          !activeClinicTypes ||
          ['CCC', 'TB', 'DIABETIC', 'HYPERTENSION', 'ONCOLOGY', 'DIALYSIS'].some((t) =>
            activeClinicTypes.has(t)
          ),
      },
      {
        label: 'Immunization',
        href: '/clinics/immunization',
        icon: Syringe,
        visibleWhen: ({ activeClinicTypes }) =>
          !activeClinicTypes || activeClinicTypes.has('IMMUNIZATION'),
      },
      {
        label: 'Enrollments',
        href: '/clinics/enrollments',
        icon: ClipboardList,
        actionKey: 'clinics.manage_queue',
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        icon: Target,
        actionKey: 'immunizations.manage_campaigns',
      },
      {
        label: 'AEFI Reports',
        href: '/immunizations/aefi',
        icon: ShieldAlert,
        actionKey: 'immunizations.view_records',
      },
      {
        label: 'Stock',
        href: '/immunizations/stock',
        icon: Package,
        actionKey: 'immunizations.manage_stock',
      },
      {
        label: 'Cold Chain',
        href: '/immunizations/cold-chain',
        icon: Thermometer,
        actionKey: 'immunizations.manage_cold_chain',
      },
      {
        label: 'Incidents',
        href: '/immunizations/incidents',
        icon: AlertTriangle,
        actionKey: 'immunizations.report_incident',
      },
      {
        label: 'Coverage',
        href: '/immunizations/coverage',
        icon: BarChart3,
        actionKey: 'immunizations.view_coverage',
      },
    ],
  },
  {
    ...
    children: [
      { label: 'Registrations', href: '/mch', icon: ClipboardList, actionKey: 'mch.register' },
      {
        ...
        href: '/mch/deliveries',
        icon: Venus,
        actionKey: 'mch.record_delivery',
      },
      {
        label: 'Growth Charts',
        href: '/mch/growth',
        icon: BarChart3,
        actionKey: 'mch.view_growth',
      },
      {
        label: 'Immunizations',
        href: '/mch/immunizations',
        icon: Syringe,
        actionKey: 'mch.immunize',
      },
    ...
    children: [
      {
        ...
        href: '/procedures',
        icon: LayoutDashboard,
        actionKey: 'procedures.view_dashboard',
      },
      {
        label: 'Orders',
        href: '/procedures/orders',
        icon: SquareDashedTopSolid,
        actionKey: 'procedures.view_orders',
      },
      {
        label: 'External Requests',
        href: '/procedures/external-requests',
        icon: Inbox,
        actionKey: 'procedures.view_orders',
      },
      {
        label: 'Catalog',
        href: '/procedures/catalog',
        icon: Syringe,
        actionKey: 'procedures.view_catalog',
      },
      {
        label: 'Room Assignments',
        href: '/procedures/catalog/clinic-mappings',
        icon: Network,
        actionKey: 'procedures.view_catalog',
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        icon: FileText,
        actionKey: 'inpatient.view_reviews',
      },
      {
        label: 'Kardex',
        href: '/inpatient/kardex',
        icon: ClipboardList,
        actionKey: 'inpatient.view_kardex',
      },
      {
        label: 'Rounds',
        href: '/inpatient/rounds',
        icon: Stethoscope,
        actionKey: 'inpatient.make_rounds',
      },
      {
        label: 'Supervisor Alerts',
        href: '/inpatient/alerts',
        icon: AlertTriangle,
        actionKey: 'inpatient.view_alerts',
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        href: '/last-office',
        icon: ClipboardList,
        actionKey: 'last_office.view_records',
      },
      {
        label: 'Record Death',
        href: '/last-office/new',
        icon: Skull,
        actionKey: 'last_office.record_death',
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        href: '/blood-bank',
        icon: LayoutDashboard,
        actionKey: 'blood_bank.view_dashboard',
      },
      {
        label: 'Donors',
        href: '/blood-bank/donors',
        icon: UserPlus,
        actionKey: 'blood_bank.view_donors',
      },
      {
        label: 'Units',
        href: '/blood-bank/units',
        icon: Package,
        actionKey: 'blood_bank.view_units',
      },
      {
        label: 'Requests',
        href: '/blood-bank/requests',
        icon: ClipboardList,
        actionKey: 'blood_bank.view_requests',
      },
      {
        label: 'Cross-Match',
        href: '/blood-bank/crossmatch',
        icon: Target,
        actionKey: 'blood_bank.view_crossmatch',
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        href: '/dialysis',
        icon: LayoutDashboard,
        actionKey: 'dialysis.view_dashboard',
      },
      {
        label: 'Sessions',
        href: '/dialysis/sessions',
        icon: Activity,
        actionKey: 'dialysis.view_sessions',
      },
      {
        label: 'Orders',
        href: '/dialysis/orders',
        icon: ClipboardList,
        actionKey: 'dialysis.view_orders',
      },
      {
        label: 'Vascular Access',
        href: '/dialysis/accesses',
        icon: CircleDot,
        actionKey: 'dialysis.view_accesses',
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        href: '/pharmacy',
        icon: LayoutDashboard,
        actionKey: 'pharmacy.view_dashboard',
      },
      {
        label: 'Dispensing',
        href: '/pharmacy/dispensing',
        icon: FlaskConical,
        actionKey: 'pharmacy.dispense',
      },
      {
        label: 'Prescriptions',
        href: '/pharmacy/prescriptions',
        icon: FileText,
        actionKey: 'pharmacy.view_prescriptions',
      },
      {
        label: 'Item Catalog',
        href: '/pharmacy/drugs',
        icon: Pill,
        actionKey: 'pharmacy.view_drugs',
      },
      {
        label: 'Quick Receive',
        href: '/pharmacy/stock/receive',
        icon: ClipboardList,
        actionKey: 'pharmacy.manage_stock',
      },
      {
        label: 'Adjustments',
      ...
      },
      {
        ...
        href: '/pharmacy/standalone/walk-in',
        icon: UserPlus,
        actionKey: 'pharmacy.dispense',
        facilityModule: 'pharmacy_standalone',
      },
      {
        label: 'Standalone Prescription',
        href: '/pharmacy/standalone/new-prescription',
        icon: Pill,
        actionKey: 'pharmacy.dispense',
        facilityModule: 'pharmacy_standalone',
      },
      {
        label: 'External Prescriptions',
        href: '/pharmacy/standalone/external-prescriptions',
        icon: Inbox,
        actionKey: 'pharmacy.view_prescriptions',
        facilityModule: 'pharmacy_standalone',
      },
      {
        ...
        icon: BarChart3,
        actionKey: 'pharmacy.view_reports',
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        href: '/laboratory',
        icon: LayoutDashboard,
        actionKey: 'laboratory.view_dashboard',
      },
      {
        label: 'Orders',
        href: '/laboratory/orders',
        icon: SquareDashedTopSolid,
        actionKey: 'laboratory.view_orders',
      },
      {
        label: 'Validations',
        href: '/laboratory/validations',
        icon: CheckSquare,
        actionKey: 'laboratory.verify_results',
      },
      {
        label: 'Test Catalog',
      ...
      },
      {
        ...
        icon: FileText,
        actionKey: 'laboratory.view_reports',
      },
      {
        label: 'Lab Analytics',
        href: '/laboratory/analytics',
        icon: BarChart3,
        actionKey: 'laboratory.view_analytics',
      },
      {
      ...
      {
        label: 'Auto-Verify',
        href: '/laboratory/autoverify',
        icon: ShieldCheck,
        actionKey: 'laboratory.verify_results',
      },
      {
        label: 'Analyzers',
        href: '/laboratory/analyzers',
        icon: Cpu,
        actionKey: 'laboratory.view_dashboard',
      },
      {
        label: 'Microbiology',
        href: '/laboratory/microbiology',
        icon: Bug,
        actionKey: 'laboratory.view_dashboard',
      },
      {
        label: 'Worksheets',
        href: '/laboratory/worksheets',
        icon: FileSpreadsheet,
        actionKey: 'laboratory.view_dashboard',
      },
      {
        label: 'Reflex Testing',
        href: '/laboratory/reflex',
        icon: Repeat2,
        actionKey: 'laboratory.view_dashboard',
      },
      {
        label: 'Critical Values',
        href: '/laboratory/critical-values',
        icon: BellRing,
        actionKey: 'lis.manage_critical_values',
      },
      {
        label: 'Walk-in Patients',
        href: '/laboratory/standalone/walk-in',
        icon: UserPlus,
        actionKey: 'lis.register_walkin',
        facilityModule: 'lis_standalone',
      },
      {
        label: 'Standalone Order',
        href: '/laboratory/standalone/new-order',
        icon: FlaskConical,
        actionKey: 'lis.create_standalone_order',
        facilityModule: 'lis_standalone',
      },
      {
        label: 'External Orders',
        href: '/laboratory/standalone/external-orders',
        icon: Inbox,
        actionKey: 'lis.view_external_orders',
        facilityModule: 'lis_standalone',
      },
    ...
    children: [
      {
        ...
        href: '/imaging',
        icon: LayoutDashboard,
        actionKey: 'imaging.view_dashboard',
      },
      {
        label: 'Worklist',
        href: '/imaging/worklist',
        icon: ListOrdered,
        actionKey: 'imaging.view_orders',
      },
      {
      ...
      },
      {
        ...
        icon: BookOpen,
        actionKey: 'imaging.manage_catalog',
      },
      {
        label: 'Reports',
      ...
      },
      {
        ...
        icon: ImageIcon,
        actionKey: 'imaging.view_studies',
      },
      {
        label: 'Equipment',
        href: '/imaging/equipment',
        icon: Cpu,
        actionKey: 'imaging.manage_equipment',
      },
      {
        label: 'Settings',
        href: '/imaging/settings',
        icon: Settings,
        actionKey: 'imaging.manage_equipment',
      },
      {
        label: 'Walk-in Patients',
        href: '/imaging/standalone/walk-in',
        icon: UserPlus,
        actionKey: 'imaging.view_orders',
        facilityModule: 'imaging_standalone',
      },
      {
        label: 'Standalone Order',
        href: '/imaging/standalone/new-order',
        icon: ScanLine,
        actionKey: 'imaging.view_orders',
        facilityModule: 'imaging_standalone',
      },
    ...
    children: [
      {
        ...
        href: '/allied-health',
        icon: LayoutDashboard,
        actionKey: 'allied_health.view_dashboard',
      },
      {
        label: 'Physiotherapy',
        href: '/allied-health/physiotherapy',
        icon: Dumbbell,
        actionKey: 'allied_health.assess_physio',
      },
      {
        label: 'Nutrition',
        href: '/allied-health/nutrition',
        icon: Apple,
        actionKey: 'allied_health.assess_nutrition',
      },
      {
        label: 'Occupational Therapy',
        href: '/allied-health/occupational-therapy',
        icon: HeartHandshake,
        actionKey: 'allied_health.assess_occupational',
      },
      {
        label: 'Social Work',
        href: '/allied-health/social-work',
        icon: UsersRound,
        actionKey: 'allied_health.counsel',
      },
      {
        label: 'Counselling',
    ...
    children: [
      {
        ...
        href: '/theatre',
        icon: LayoutDashboard,
        actionKey: 'theatre.view_schedule',
      },
      {
        label: 'Schedule',
      ...
      {
        label: 'Checklists',
        href: '/theatre/checklists',
        icon: CheckSquare,
        actionKey: 'theatre.view_checklists',
      },
      {
        label: 'Cases',
        href: '/theatre/cases',
        icon: SquareDashedTopSolid,
        actionKey: 'theatre.schedule_case',
      },
      {
        label: 'Anesthesia',
        href: '/theatre/anesthesia',
        icon: Syringe,
        actionKey: 'theatre.record_notes',
      },
      {
        label: 'Equipment',
        href: '/theatre/equipment',
        icon: Wrench,
        actionKey: 'theatre.manage_settings',
      },
      {
        label: 'Reports',
        href: '/theatre/reports',
        icon: BarChart3,
        actionKey: 'theatre.view_reports',
      },
      {
        label: 'Setup',
        href: '/theatre/settings',
        icon: Settings,
        actionKey: 'theatre.manage_settings',
      },
    ],
    ...
    children: [
      {
        ...
        icon: ChartNoAxesGantt,
        actionKey: 'billing.view_dashboard',
      },
      {
        label: 'Invoices',
        href: '/transactions/invoices',
        icon: FileText,
        actionKey: 'billing.view_invoices',
      },
      {
        label: 'Proformas',
        href: '/transactions/proformas',
        icon: Clock,
        actionKey: 'billing.view_proformas',
      },
      {
        label: 'Payments',
        href: '/transactions/payments',
        icon: CreditCard,
        actionKey: 'billing.record_payment',
      },
      {
        label: 'Receipts',
        href: '/transactions/receipts',
        icon: Receipt,
        actionKey: 'billing.view_receipts',
      },
      {
        label: 'Credit Notes',
        href: '/transactions/credit-notes',
        icon: ScrollText,
        actionKey: 'billing.view_credit_notes',
      },
      {
        label: 'SHA Claims',
        href: '/transactions/sha-claims',
        icon: SHAIcon,
      ...
      {
        label: 'Capitation',
        href: '/transactions/capitation',
        icon: Repeat2,
        actionKey: 'billing.view_reports',
        requiresInternet: true,
        visibleWhen: ({ facilityLevel, facilityOwnership }) => {
      ...
      {
        label: 'OTP Whitelist',
        href: '/transactions/sha-claims/whitelist',
        icon: ShieldAlert,
        actionKey: 'billing.submit_sha_claim',
        requiresInternet: true,
      },
      {
        ...
        icon: FileSpreadsheet,
        actionKey: 'billing.view_supplier_bills',
      },
      {
        label: 'Reports',
      ...
      },
      {
        ...
        href: '/finance/payment-points',
        icon: Wallet,
        actionKey: 'billing.view_dashboard',
      },
      {
        label: 'Payments Config',
        href: '/finance/payments-config',
        icon: Settings,
        actionKey: 'billing.view_dashboard',
      },
    ],
  },
  {
    ...
    icon: Shield,
    moduleKey: 'billing',
    facilityModule: 'private_insurance',
    requiresInternet: true,
    children: [
      {
        label: 'Dashboard',
        href: '/insurance',
        icon: LayoutDashboard,
        actionKey: 'billing.view_insurance',
        requiresInternet: true,
      },
      {
        label: 'Providers',
        ...
        icon: Building2,
        actionKey: 'billing.manage_insurance_providers',
        requiresInternet: true,
      },
      {
        label: 'Claims',
      ...
      {
        label: 'Enrollments',
        href: '/insurance/enrollments',
        icon: ClipboardList,
        actionKey: 'billing.view_insurance',
        requiresInternet: true,
      },
      {
        label: 'Slade Credentials',
        href: '/insurance/slade-credentials',
        icon: Lock,
        actionKey: 'billing.manage_insurance_config',
        requiresInternet: true,
      },
      {
        label: 'Provider Configs',
        href: '/insurance/provider-configs',
        icon: Settings,
        actionKey: 'billing.manage_insurance_config',
        requiresInternet: true,
      },
    ...
    children: [
      {
        ...
        href: '/inventory',
        icon: LayoutDashboard,
        actionKey: 'inventory.view_dashboard',
      },
      {
        label: 'Suppliers',
        href: '/inventory/suppliers',
        icon: Building2,
        actionKey: 'inventory.view_suppliers',
      },
      {
        label: 'Purchase Orders',
        href: '/inventory/purchase-orders',
        icon: FileText,
        actionKey: 'inventory.view_purchase_orders',
      },
      {
        label: 'Formal Goods Receipt',
        href: '/inventory/goods-receipt',
        icon: ClipboardList,
        actionKey: 'inventory.view_goods_receipts',
      },
      {
        label: 'Store Locations',
        href: '/inventory/store-locations',
        icon: Hospital,
        actionKey: 'inventory.view_store_locations',
      },
      {
        label: 'Transfers',
        href: '/inventory/transfers',
        icon: ArrowLeftRight,
        actionKey: 'inventory.view_transfers',
      },
      {
        label: 'Ward Stock',
        href: '/inventory/ward-stock',
        icon: BedDouble,
        actionKey: 'inventory.view_ward_stock',
      },
      {
        label: 'Stock Counts',
        href: '/inventory/stock-counts',
        icon: ListOrdered,
        actionKey: 'inventory.view_stock_counts',
      },
      {
        label: 'eTIMS',
        href: '/inventory/etims',
        icon: Receipt,
        actionKey: 'inventory.view_etims',
        requiresInternet: true,
      },
      {
        label: 'Forecasting',
        ...
        icon: BarChart3,
        actionKey: 'inventory.view_forecasts',
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        href: '/quality',
        icon: LayoutDashboard,
        actionKey: 'quality.view_dashboard',
      },
      {
        label: 'Measures',
        href: '/quality/measures',
        icon: Target,
        actionKey: 'quality.view_measures',
      },
      {
        label: 'Benchmarks',
      ...
      },
      {
        ...
        href: '/quality/reports/quarterly',
        icon: BarChart3,
        actionKey: 'quality.view_reports',
      },
      {
        label: 'Annual Reports',
        href: '/quality/reports/annual',
        icon: FileText,
        actionKey: 'quality.view_reports',
      },
    ],
  ...
  } as NavItemWithChildren,
  {
    ...
    children: [
      ...
      },
      {
        ...
        icon: Monitor,
        actionKey: 'admin.manage_licensing',
        visibleWhen: ({ isSuperuser }) => isSuperuser === true,
      },
      {
        label: 'Facilities',
      ...
      },
      {
        ...
        href: '/admin/facility-lookup',
        icon: KenyaCoatOfArmsIcon,
        actionKey: 'admin.manage_departments',
        requiresInternet: true,
      },
      {
        label: 'SHA Intervention Lookup',
        href: '/admin/sha-intervention-lookup',
        icon: KenyaCoatOfArmsIcon,
        actionKey: 'admin.manage_departments',
        requiresInternet: true,
      },
      ...
      {
        label: 'HL7 Messages',
        href: '/admin/hl7-messages',
        icon: Network,
        actionKey: 'admin.view_hl7_messages',
        requiresInternet: true,
      },
      {
        label: 'HL7 Endpoints',
        href: '/admin/hl7-endpoints',
        icon: Network,
        actionKey: 'admin.view_hl7_messages',
        requiresInternet: true,
      },
      {
        label: 'KENHDD Compliance',
        href: '/admin/kenhdd-compliance',
        icon: BookCheck,
        actionKey: 'admin.view_audit_logs',
      },
 ...
 */
export const bottomNavItems: NavItem[] = [{ label: 'Settings', href: '/settings', icon: Settings }];

/**
 * Get all parent labels that have children (for auto-expand logic)
 */
export function getParentLabels(): string[] {
  return mainNavItems.filter(hasChildren).map((item) => item.label);
}
