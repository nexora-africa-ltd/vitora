...
const _allNavItems: NavItemType[] = [
  ...
  },
  {
    ...
    children: [
      { label: 'Dashboard', href: '/insurance', icon: LayoutDashboard, actionKey: 'billing.view_insurance', requiresInternet: true },
      { label: 'Providers', href: '/insurance/providers', icon: Building2, actionKey: 'billing.manage_insurance_providers', requiresInternet: true },
      ...
      { label: 'Remittances', href: '/insurance/remittances', icon: TrendingUp, actionKey: 'billing.view_insurance', requiresInternet: true },
      { label: 'Tariffs', href: '/insurance/tariffs', icon: Tag, actionKey: 'billing.view_insurance', requiresInternet: true },
    ],
  },
  {
    label: 'Inventory',
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Knowledge Base', href: '/ai/knowledge-base', icon: Library, actionKey: 'ai.use_chat' },
