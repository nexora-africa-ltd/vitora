...
export const BloodTransfusionSchema = z.object({
  ...
  blood_bank_unit: z.number().nullable().optional(),
...
export const ATRDetailSchema = z.object({
  id: z.number(),
  transfusion: z.number(),
  patient_name: z.string().optional().default(''),
  patient_mrn: z.string().optional().default(''),
  patient_gender: z.string().optional().default(''),
  patient_date_of_birth: z.string().optional().default(''),
  ward_name: z.string().optional().default(''),
  transfusion_diagnosis: z.string().optional().default(''),
  started_by_name: z.string().optional().default(''),
  admission_id: z.number().optional(),
  blood_product: z.string().optional().default(''),
  blood_product_display: z.string().optional().default(''),
  blood_unit_number: z.string().optional().default(''),
  amount_ml: z.number().optional(),
  volume_transfused_ml: z.number().nullable().optional(),
  transfusion_expiry_date: z.string().nullable().optional(),
  pre_transfusion_hb: z.string().nullable().optional(),
  obstetric_status: z.string().default('NA'),
  gravida: z.number().nullable().optional(),
  para: z.number().nullable().optional(),
  previous_transfusion: z.boolean().nullable().optional(),
  previous_transfusion_comment: z.string().optional().default(''),
  previous_reactions: z.boolean().nullable().optional(),
  previous_reactions_comment: z.string().optional().default(''),
  current_medications: z.string().optional().default(''),
  general_reactions: z.array(z.string()).default([]),
  dermatological_reactions: z.array(z.string()).default([]),
  cardiac_respiratory_reactions: z.array(z.string()).default([]),
  renal_reactions: z.array(z.string()).default([]),
  haematological_reactions: z.array(z.string()).default([]),
  other_reactions: z.string().optional().default(''),
  reaction_categories_display: z.array(z.string()).optional().default([]),
  vitals_at_start_bp: z.string().optional().default(''),
  vitals_at_start_temp: z.string().nullable().optional(),
  vitals_at_start_pulse: z.number().nullable().optional(),
  vitals_at_start_rr: z.number().nullable().optional(),
  vitals_during_bp: z.string().optional().default(''),
  vitals_during_temp: z.string().nullable().optional(),
  vitals_during_pulse: z.number().nullable().optional(),
  vitals_during_rr: z.number().nullable().optional(),
  vitals_at_stop_bp: z.string().optional().default(''),
  vitals_at_stop_temp: z.string().nullable().optional(),
  vitals_at_stop_pulse: z.number().nullable().optional(),
  vitals_at_stop_rr: z.number().nullable().optional(),
  recipient_supernatant_hemolysis: z.string().optional().default(''),
  recipient_hemolysis_severity: z.string().optional().default(''),
  recipient_agglutination: z.string().optional().default(''),
  haematological_results: z.record(z.string(), z.string()).optional().default({}),
  blood_film_rbc: z.string().optional().default(''),
  blood_film_wbc: z.string().optional().default(''),
  blood_film_plt: z.string().optional().default(''),
  donor_supernatant_hemolysis: z.string().optional().default(''),
  donor_pack_age: z.string().optional().default(''),
  culture_donor_pack_results: z.string().optional().default(''),
  culture_recipient_blood_results: z.string().optional().default(''),
  compatibility_saline_rt: z.string().optional().default(''),
  compatibility_saline_37: z.string().optional().default(''),
  compatibility_ahg: z.string().optional().default(''),
  compatibility_albumin_37: z.string().optional().default(''),
  enzyme_treated_cells_result: z.string().optional().default(''),
  anti_a_titres: z.string().optional().default(''),
  anti_b_titres: z.string().optional().default(''),
  urinalysis: z.string().optional().default(''),
  evaluation_diagnosis: z.string().optional().default(''),
  reaction_related_to_transfusion: z.string().optional().default(''),
  has_lab_investigation: z.boolean().optional().default(false),
  initial_reporter: z.number().nullable().optional(),
  initial_reporter_username: z.string().nullable().optional(),
  initial_reporter_cadre: z.string().optional().default(''),
  initial_reporter_mobile: z.string().optional().default(''),
  initial_reporter_email: z.string().optional().default(''),
  report_date: z.string(),
  ppb_submitter_name: z.string().optional().default(''),
  ppb_submitter_cadre: z.string().optional().default(''),
  ppb_submitter_mobile: z.string().optional().default(''),
  ppb_submitter_email: z.string().optional().default(''),
...
export const ATRListSchema = z.object({
  id: z.number(),
  transfusion: z.number(),
  admission_id: z.number().optional(),
  patient_name: z.string().optional().default(''),
