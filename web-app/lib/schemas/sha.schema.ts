...
export const ClaimItemSchema = z.object({
  ...
  invoice_item: z.number().nullable().optional(),
  description: z.string(),
  service_date: z.string().nullable().optional(),
  quantity: z.union([z.string(), z.number()]),
  unit_price: z.string(),
  claimed_amount: z.string(),
  sha_covered_amount: z.string().nullable().optional(),
  patient_payable_amount: z.string().nullable().optional(),
  discount_amount: z.string().nullable().optional(),
  discount_reason: z.string().nullable().optional(),
  discount_applied_by: z.number().nullable().optional(),
  discount_applied_at: z.string().nullable().optional(),
  allocation_status: z.enum(['pending', 'resolved']).optional(),
  coverage_type: CoverageTypeSchema,
  coverage_type_display: z.string().optional(),
  status: ClaimItemStatusSchema,
  approved_quantity: z.union([z.string(), z.number()]).nullable().optional(),
  approved_amount: z.string().nullable().optional(),
  rejection_reason: z.string().nullable().optional(),
  created_at: z.string(),
  updated_at: z.string(),
