...
export const LabOrderSchema = z.object({
  ...
  billing_patient: z.number().nullable().optional(),
  billing_patient_name: z.string().nullable().optional(),
  encounter: z.number().nullable(),
  admission: z.number().nullable().optional(),
  blood_bank_unit: z.number().nullable().optional(),
  blood_bank_unit_number: z.string().nullable().optional(),
  ordered_by: z.number(),
...
export const ResultCommentTemplateSchema = z.object({
  ...
  name: z.string(),
  text: z.string(),
  category: z.enum(['GENERAL', 'CRITICAL', 'FOLLOW_UP', 'METHODOLOGY', 'QUALITY']),
...
export const LabBarcodeConfigSchema = z.object({
  ...
  separator: z.string(),
  barcode_format: z.enum(['CODE128', 'CODE39', 'QR']),
