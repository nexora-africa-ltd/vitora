...
export const ClinicalReferralSchema = z.object({
  ...
  patient_date_of_birth: z.string().nullable().default(null),
  patient_phone: z.string().default(''),
  encounter: z.number(),
  destination_clinic: z.number().nullable(),
  ...
  cancelled_by: z.number().nullable().default(null),
  cancelled_by_name: z.string().default(''),
  cancel_reason: z.string().default(''),
