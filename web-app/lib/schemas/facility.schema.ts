...
export const FacilityDetailSchema = FacilityListItemSchema.extend({
  facility_registry_code: z.string().default(''),
  country_code: z.string().default('KE'),
  ward: z.number().nullable().optional(),
  ward_name: z.string().nullable().optional(),
  region_state: z.string().default(''),
  ...
  deployment_profile: z.enum(['full_hmis', 'lis_standalone']),
  workstation_id: z.string().default(''),
  biometrics_enforced: z.boolean().default(false),
  biometrics_agent_national_id: z.string().default(''),
  ...
  has_icu: z.boolean(),
  has_hdu: z.boolean().default(false),
  has_nbu: z.boolean().default(false),
  ...
  has_procedures: z.boolean().default(false),
