...
export const ANCVisitSchema = z.object({
  ...
  weight: z.number().nullable(),
  blood_pressure: z.string(),
  fundal_height: z.number().nullable(),
  fetal_heart_rate: z.number().nullable(),
...
export const DeliverySchema = z.object({
  ...
  is_low_birth_weight: z.boolean(),
  is_macrosomia: z.boolean(),
  alerts: z.array(z.string()),
  notes: z.string(),
  created_at: z.string(),
  updated_at: z.string(),
...
export const PNCVisitSchema = z.object({
  ...
  baby_weight: z.number().nullable(),
  baby_temperature: z.number().nullable(),
...
export const GrowthMeasurementSchema = z.object({
  ...
  muac: z.number().nullable(),
  weight_for_age_z: z.number().nullable(),
  height_for_age_z: z.number().nullable(),
  weight_for_height_z: z.number().nullable(),
  bmi_for_age_z: z.number().nullable(),
  head_circumference_for_age_z: z.number().nullable(),
  muac_classification: MUACClassificationSchema,
  nutritional_status: NutritionalStatusSchema,
  has_critical_flag: z.boolean(),
  alerts: z.array(z.string()),
