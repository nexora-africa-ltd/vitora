...
def mock_requests_get():
    ...
    """
    with patch('hmis.apps.billing.services.dha_search.requests.get') as mock_dha, \
...
def mock_requests_post():
    ...
    """
    with patch('hmis.apps.billing.services.dha_search.requests.post') as mock_dha, \
...
def mock_requests_put():
    ...
    """
    with patch('hmis.apps.billing.services.dha_search.requests.put') as mock_dha, \
