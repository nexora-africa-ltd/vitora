...
class TestSHAClaimModel:
    ...
    def test_claim_number_sequential_generation(self, valid_claim_data, sample_county, sample_sub_county, test_user):
    ...
    def test_all_claim_type_choices_accepted(self, valid_claim_data):
        ...
        expected_types = [
            'outpatient', 'inpatient', 'maternity', 'surgery',
            'chronic', 'emergency', 'dental', 'optical', 'dialysis'
        ]
...
class TestSHAClaimValidateForSubmission:
    ...
    # =========================================================================
    def test_validate_for_submission_missing_tariff_fails(
    ...
    # =========================================================================
    def test_validate_for_submission_missing_attachments_fails(
        self, valid_claim_data, sha_tariff
    ):
    ...
    # =========================================================================
    def test_validate_for_submission_zero_amount_fails(
        self, valid_claim_data, test_user
    ):
...
class TestSHAClaimSubmit:
    ...
    # =========================================================================
    def test_submit_updates_status_and_timestamps(
        self, valid_claim_data, sha_tariff, test_user
    ):
