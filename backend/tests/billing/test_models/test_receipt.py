...
class TestReceipt:
    ...
    def test_receipt_creation_with_payment(
    ...
    def test_receipt_number_auto_generated(
        self, sample_invoice, billing_user, consultation_service
    ):
    ...
    def test_amount_in_words_conversion(self, sample_invoice, billing_user, consultation_service):
        ...
        assert (
            "two hundred" in receipt.amount_in_words.lower()
            or "twelve hundred" in receipt.amount_in_words.lower()
        )

    def test_receipt_patient_denormalization(
        self, sample_invoice, billing_user, consultation_service
    ):
    ...
    def test_receipt_facility_denormalization(
        self, sample_invoice, billing_user, consultation_service
    ):
    ...
    def test_voided_receipt_cannot_be_voided_again(
        self, sample_invoice, billing_user, consultation_service
    ):
