...
class TestCreditNote:
    ...
    def test_credit_note_number_auto_generated(
        self, sample_invoice, billing_user, consultation_service
    ):
    ...
    def test_credit_note_amount_not_exceed_invoice(
        self, sample_invoice, billing_user, consultation_service
    ):
    ...
    def test_approval_workflow(self, sample_invoice, billing_user, consultation_service, db):
        ...
        approver = User.objects.create_user(username="approver", password="testpass123")
    ...
    def test_approval_by_different_user(
        self, sample_invoice, billing_user, consultation_service, db
    ):
    ...
    def test_refund_processing(self, sample_invoice, billing_user, consultation_service, db):
        ...
        # Create another user for approval
        approver = User.objects.create_user(username="approver2", password="testpass123")
    ...
    def test_rejected_credit_note(self, sample_invoice, billing_user, consultation_service, db):
        ...
        reviewer = User.objects.create_user(username="reviewer", password="testpass123")
    ...
    def test_credit_note_audit_trail(self, sample_invoice, billing_user, consultation_service, db):
        ...
        # Create another user for approval
        approver = User.objects.create_user(username="approver3", password="testpass123")
