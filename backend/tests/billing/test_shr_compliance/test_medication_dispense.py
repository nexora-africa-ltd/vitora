...
class TestMedicationDispenseRequiredFields:
    ...
    def test_medication_dispense_has_id(self, valid_medication_dispense_fhir):
        ...
        """
        assert 'id' in valid_medication_dispense_fhir, (
            "MedicationDispense must have 'id' field"
        )
        assert valid_medication_dispense_fhir['id'], (
            "MedicationDispense id must not be empty"
        )
    ...
    def test_medication_dispense_has_medication(self, valid_medication_dispense_fhir):
        ...
        """
        has_medication = (
            'medicationCodeableConcept' in valid_medication_dispense_fhir or
            'medicationReference' in valid_medication_dispense_fhir
        )
...
class TestMedicationDispenseMedicationCoding:
    ...
    def test_medication_coding_matches_request(self, valid_medication_dispense_fhir, valid_medication_request_fhir):
        """
...
class TestMedicationDispensePerformer:
    ...
    def test_performer_has_actor(self, valid_medication_dispense_fhir):
        ...
        assert 'actor' in performer, (
            "performer must have 'actor' field"
        )
    ...
    def test_performer_includes_pharmacist(self, valid_medication_dispense_fhir):
        ...
        has_practitioner = any(
            'Practitioner/' in p.get('actor', {}).get('reference', '')
            for p in performers
        )
    ...
    def test_performer_includes_organization(self, valid_medication_dispense_fhir):
        ...
        has_organization = any(
            'Organization/' in p.get('actor', {}).get('reference', '')
            for p in performers
        )
...
class TestMedicationDispenseAuthorizingPrescription:
    ...
    def test_authorizing_prescription_has_reference(self, valid_medication_dispense_fhir):
        ...
        assert 'reference' in auth_rx, (
            "authorizingPrescription must have 'reference' field"
        )

    def test_authorizing_prescription_references_medication_request(self, valid_medication_dispense_fhir):
        """
...
class TestMedicationDispenseType:
    ...
    def test_type_has_coding(self, valid_medication_dispense_fhir):
        ...
        assert 'coding' in dispense_type, (
            "type must have 'coding' array"
        )
    ...
    def test_type_uses_v3_act_code(self, valid_medication_dispense_fhir):
        ...
        assert 'v3-ActCode' in coding['system'], (
            "type coding should use v3-ActCode system"
        )
...
class TestMedicationDispenseDaysSupply:
    ...
    def test_days_supply_has_value(self, valid_medication_dispense_fhir):
        ...
        assert 'value' in days_supply, (
            "daysSupply must have 'value' field"
        )
    ...
    def test_days_supply_has_unit(self, valid_medication_dispense_fhir):
        ...
        """
        days_supply = valid_medication_dispense_fhir.get('daysSupply', {})
        assert 'unit' in days_supply, (
            "daysSupply must have 'unit' field"
        )
        assert days_supply['unit'] == 'days', (
            "daysSupply unit should be 'days'"
        )
...
class TestMedicationDispenseSubjectConsistency:
    ...
    def test_dispense_subject_matches_request(self, valid_medication_dispense_fhir, valid_medication_request_fhir):
        """
