...
@pytest.fixture
def sample_dispensing(db, sample_prescription_item, sample_patient, sample_drug, sample_stock_batch, pharmacist_user):
...
@pytest.fixture
def ips_bundle_with_dispense_history(valid_ips_bundle, valid_medication_request_fhir, valid_medication_dispense_fhir):
    """
