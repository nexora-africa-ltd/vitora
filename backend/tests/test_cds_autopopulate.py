...
class TestAlertSuggestedActionsSerializer:
    ...
    @pytest.fixture
    def sample_alert_with_actions(self, vital_rule_with_actions, sample_patient):
    ...
    def test_alert_without_actions_returns_empty(self, vital_rule_with_actions, sample_patient):
