    ...
    def test_all_phase5_endpoints_404_when_master_disabled(self, authenticated_client):
        ...
        endpoints = [
            ...
            (
                ...
                {
                    "free_text": "Patient presents with fever and cough for three days",
                    "note_format": "soap",
                },
            ),
            ...
            "flags": [
                {
                    ...
                    "unit": "g/dL",
                    "status": "low",
                    "reference_range": {"low": 12.0, "high": 16.0, "unit": "g/dL"},
                    "deviation_percent": 29.2,
                    "message": "hemoglobin: 8.5 g/dL (low)",
                },
            ],
            "patterns": [],
...
class TestCarePlanGenerateEndpoint:
    ...
    def test_tibabot_success(self, authenticated_client, mock_tibabot):
        mock_tibabot.generate_care_plan.return_value = {
            ...
            "goals": [
                {
                    "description": "Resolve malaria infection",
                    "priority": "high",
                    "timeframe": "3-5 days",
                    "measurable_target": "Negative blood smear",
                },
            ],
            "interventions": [
                {
                    ...
                    "items": [
                        {
                            "action": "Artemether-Lumefantrine",
                            "frequency": "BD for 3 days",
                            "rationale": "First-line ACT",
                        }
                    ],
                },
            ],
            ...
            "follow_up": {
                "timing": "Day 7",
                "instructions": "Repeat malaria test",
                "red_flags": ["Return of fever"],
            },
            ...
            "alerts": [
                {
                    ...
                    "recommendation": "Hold metformin 48h before contrast",
                },
            ],
            "recommendations": [],
            "rules_evaluated": 15,
