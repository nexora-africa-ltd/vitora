...
class TestClinicalTemplateAdminRegistration:
    ...
    def test_template_section_inline_on_template(self):
        ...
        assert "TemplateSectionInline" in inline_classes or TemplateSectionInline in admin_class.inlines
...
class TestLoadClinicalTemplatesCommand:
    ...
    def test_displays_summary(self, db, tmp_path):
        ...
        assert "loaded" in output.lower() or "created" in output.lower() or "success" in output.lower()
