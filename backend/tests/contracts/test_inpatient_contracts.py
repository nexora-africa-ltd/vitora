...
from hmis.apps.inpatient.serializers_atr_templates import (
...
from hmis.apps.inpatient.serializers_discharge_transfer import (
...
from hmis.apps.inpatient.serializers_kardex_alerts import (
    AcknowledgeAlertRequestSerializer,
    ConstraintOverrideMetricsSerializer,
    ConstraintViolationSerializer,
    CriticalCareTransferMatrixRowSerializer,
    CriticalCareWardLoadSerializer,
...
from hmis.apps.inpatient.serializers_monitoring_medication import (
...
from hmis.apps.inpatient.serializers_ward_admission import (
