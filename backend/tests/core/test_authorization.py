...
class TestRoleBasedAccess:
    ...
    def test_receptionist_can_view_patient_list(
        self, api_client, receptionist_user, sample_patient
    ):
        """
...
class TestSensitiveAccessAudit:
    ...
    def test_sensitive_access_is_logged(self, api_client, doctor_user, sensitive_patient, db):
        """
