...
class TestPharmacyReports:
    ...
    def test_expiry_report_authenticated(self, authenticated_client, sample_drug, expiring_batch):
    ...
    def test_expiry_report_filters_by_days(self, authenticated_client, sample_drug, expiring_batch):
    ...
    def test_dispensing_report_authenticated(self, authenticated_client, sample_dispensing):
    ...
    def test_dispensing_report_filters_by_date_range(self, authenticated_client, sample_dispensing):
        ...
        response = authenticated_client.get(
            url, {"start_date": yesterday.isoformat(), "end_date": tomorrow.isoformat()}
        )
