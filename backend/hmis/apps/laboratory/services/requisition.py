...
class ExternalLabRequisition:
    ...
    def _build_context(self) -> dict:
        ...
        context = {
            ...
            # Clinical info
            "clinician_name": self.lab_order.ordered_by.get_full_name()
            or self.lab_order.ordered_by.username,
    ...
    def _build_header(self, styles):
        ...
        contact_style = ParagraphStyle(
            "Contact", parent=styles["Normal"], fontSize=9, alignment=TA_CENTER
        )
    ...
    def _build_requisition_info(self, styles):
        ...
        data = [
            [
                "Requisition Number:",
                context["requisition_number"],
                "Date:",
                context["requisition_date"].strftime("%Y-%m-%d %H:%M"),
            ],
        ...
        priority_color = (
            ...
            else (colors.orange if context["priority"] == "URGENT" else colors.black)
        )
    ...
    def save_to_order(self) -> None:
        ...
        self.lab_order.requisition_pdf.save(filename, ContentFile(pdf_buffer.getvalue()), save=True)
