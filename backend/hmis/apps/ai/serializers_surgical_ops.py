...
# ruff: noqa
"""
What this file is for: surgical advisory, proactive insights, webhook, and facility knowledge-base serializers.
How to use: imported by `hmis.apps.ai.serializers` compatibility shim.
Supported inputs/args: DRF serializers for surgical and operational AI endpoints.
"""
