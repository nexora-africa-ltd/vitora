...
# ruff: noqa
"""
What this file is for: labour partograph and postnatal maternal care models.
How to use: imported by MCH model compatibility shims.
Supported inputs/args: Django model classes for labour monitoring and PNC visits.
"""
