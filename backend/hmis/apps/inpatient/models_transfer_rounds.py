...
# ruff: noqa
"""
What this file is for: inter-facility transfer, transfer events, ward rounds, and review request inpatient models.
How to use: imported by `hmis.apps.inpatient.models` compatibility module for model registration.
Supported inputs/args: Django model fields/methods for transfer and ward-round workflows.
"""
