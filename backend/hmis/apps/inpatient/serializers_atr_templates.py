...
# ruff: noqa
"""
What this file is for: adverse transfusion reaction and discharge template serializers.
How to use: imported by `hmis.apps.inpatient.serializers` compatibility shim.
Supported inputs/args: DRF serializers for ATR lifecycle and discharge template payloads.
"""
