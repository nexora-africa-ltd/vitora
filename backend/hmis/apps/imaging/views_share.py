...
# ruff: noqa
"""
What this file is for: public share-link access/download/frame endpoints for imaging studies.
How to use: imported by `hmis.apps.imaging.views` compatibility shim.
Supported inputs/args: DRF API views for study sharing and token-based retrieval flows.
"""
