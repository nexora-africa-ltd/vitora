...
class Command(BaseCommand):
    ...
    IMAGING_PROCEDURES = [
        ...
        {
            "code": "FL-MCU",
            "name": "Micturating Cystourethrogram (MCU/VCUG)",
            "modality": "FL",
            "body_region": "PELVIS",
            "cost": Decimal("6000.00"),
            "sha_claimable": True,
            "sha_intervention_code": "SHA-FL-006",
            "requires_contrast": True,
            "turnaround_hours": 24,
            "special_preparation": "Patient should have full bladder. Catheterisation required.",
        },
        {
            "code": "FL-FISTULOGRAM",
            "name": "Fistulogram",
            ...
            "cost": Decimal("6000.00"),
            "sha_claimable": True,
            "sha_intervention_code": "SHA-FL-007",
            "requires_contrast": True,
            "turnaround_hours": 24,
        },
        {
            "code": "FL-RUG",
            "name": "Retrograde Urethrogram (RUG)",
            "modality": "FL",
            "body_region": "PELVIS",
            "cost": Decimal("5500.00"),
            "sha_claimable": True,
            "sha_intervention_code": "SHA-FL-008",
            "requires_contrast": True,
            "turnaround_hours": 24,
        },
        # ADDITIONAL ULTRASOUND PROCEDURES
        {
            ...
            "cost": Decimal("3000.00"),
            "sha_claimable": True,
            "sha_intervention_code": "SHA-US-011",
            "turnaround_hours": 24,
        },
        {
            "code": "US-SOFT-TISSUE",
            ...
            "cost": Decimal("3000.00"),
            "sha_claimable": True,
            "sha_intervention_code": "SHA-US-012",
            "turnaround_hours": 24,
        },
        {
            "code": "US-MSK",
            ...
            "cost": Decimal("3500.00"),
            "sha_claimable": True,
            "sha_intervention_code": "SHA-US-013",
            "turnaround_hours": 24,
        },
        {
            "code": "US-TRANSVAGINAL",
            "name": "Transvaginal Ultrasound",
            "modality": "US",
            "body_region": "PELVIS",
            "cost": Decimal("3500.00"),
            "sha_claimable": True,
            "sha_intervention_code": "SHA-US-014",
            "turnaround_hours": 24,
            "special_preparation": "Empty bladder preferred.",
        },
        {
            "code": "US-TESTICULAR",
            "name": "Testicular/Scrotal Ultrasound",
            "modality": "US",
            "body_region": "PELVIS",
            "cost": Decimal("3000.00"),
            "sha_claimable": True,
            "sha_intervention_code": "SHA-US-015",
            "turnaround_hours": 24,
        },
        {
            "code": "US-DOPPLER-ARTERIAL",
            "name": "Arterial Doppler Ultrasound",
            "modality": "US",
            "body_region": "OTHER",
            "cost": Decimal("5000.00"),
            "sha_claimable": True,
            "sha_intervention_code": "SHA-US-016",
            "turnaround_hours": 24,
        },
        {
            "code": "US-NECK",
            "name": "Neck Soft Tissue Ultrasound",
            "modality": "US",
            "body_region": "NECK",
            "cost": Decimal("3000.00"),
            "sha_claimable": True,
            "sha_intervention_code": "SHA-US-017",
            "turnaround_hours": 24,
        },
        {
            "code": "US-NEONATAL-CRANIAL",
            "name": "Neonatal Cranial Ultrasound",
            "modality": "US",
            "body_region": "HEAD",
            "cost": Decimal("4000.00"),
            "sha_claimable": True,
            "sha_intervention_code": "SHA-US-018",
            "turnaround_hours": 24,
        },
        {
            ...
            "cost": Decimal("4000.00"),
            "sha_claimable": True,
            "sha_intervention_code": "SHA-US-019",
            "turnaround_hours": 24,
            "special_preparation": "Full bladder required. Fasting 6 hours.",
        },
        # ADDITIONAL X-RAY PROCEDURES
        {
            "code": "XR-TIBIA-FIBULA",
            "name": "Tibia/Fibula X-Ray",
            "modality": "XR",
            "body_region": "LOWER_EXTREMITY",
            "cost": Decimal("2000.00"),
            "sha_claimable": True,
            "sha_intervention_code": "SHA-XR-017",
            "turnaround_hours": 24,
        },
        {
            "code": "XR-FEMUR",
            ...
            "cost": Decimal("2000.00"),
            "sha_claimable": True,
            "sha_intervention_code": "SHA-XR-018",
            "turnaround_hours": 24,
        },
        {
            "code": "XR-FOREARM",
            ...
            "cost": Decimal("2000.00"),
            "sha_claimable": True,
            "sha_intervention_code": "SHA-XR-019",
            "turnaround_hours": 24,
        },
        {
            "code": "XR-HUMERUS",
            ...
            "cost": Decimal("2000.00"),
            "sha_claimable": True,
            "sha_intervention_code": "SHA-XR-020",
            "turnaround_hours": 24,
        },
        {
            "code": "XR-CLAVICLE",
            ...
            "cost": Decimal("1500.00"),
            "sha_claimable": True,
            "sha_intervention_code": "SHA-XR-021",
            "turnaround_hours": 24,
        },
        {
            "code": "XR-RIBS",
            ...
            "cost": Decimal("2000.00"),
            "sha_claimable": True,
            "sha_intervention_code": "SHA-XR-022",
            "turnaround_hours": 24,
        },
        {
            "code": "XR-SINUSES",
            "name": "Sinus X-Ray (Waters View)",
            "modality": "XR",
            "body_region": "HEAD",
            "cost": Decimal("1500.00"),
            "sha_claimable": True,
            "sha_intervention_code": "SHA-XR-023",
            "turnaround_hours": 24,
        },
        {
            "code": "XR-MANDIBLE",
            "name": "Mandible X-Ray (OPG)",
            "modality": "XR",
            "body_region": "HEAD",
            "cost": Decimal("2000.00"),
            "sha_claimable": True,
            "sha_intervention_code": "SHA-XR-024",
            "turnaround_hours": 24,
        },
        # ADDITIONAL CT PROCEDURES
        {
            "code": "CT-KUB",
            "name": "CT KUB (Non-Contrast)",
            "modality": "CT",
            "body_region": "ABDOMEN",
            "cost": Decimal("12000.00"),
            "sha_claimable": True,
            "sha_intervention_code": "SHA-CT-012",
            "turnaround_hours": 24,
            "special_preparation": "No contrast required. No fasting needed.",
        },
        {
            "code": "CT-NECK-C",
            ...
            "cost": Decimal("15000.00"),
            "sha_claimable": True,
            "sha_intervention_code": "SHA-CT-013",
            "requires_contrast": True,
            "turnaround_hours": 24,
            "special_preparation": "Check renal function. Fasting 4 hours.",
        },
        {
            "code": "CT-PELVIS-C",
            "name": "CT Pelvis with Contrast",
            "modality": "CT",
            "body_region": "PELVIS",
            "cost": Decimal("15000.00"),
            "sha_claimable": True,
            "sha_intervention_code": "SHA-CT-014",
            "requires_contrast": True,
            "turnaround_hours": 24,
            "special_preparation": "Check renal function. Fasting 4 hours.",
        },
        {
            "code": "CT-FACIAL-BONES",
            "name": "CT Facial Bones",
            "modality": "CT",
            "body_region": "HEAD",
            "cost": Decimal("12000.00"),
            "sha_claimable": True,
            "sha_intervention_code": "SHA-CT-015",
            "turnaround_hours": 24,
        },
        {
            "code": "CT-SPINE-THORACIC",
            "name": "CT Thoracic Spine",
            "modality": "CT",
            "body_region": "SPINE",
            "cost": Decimal("15000.00"),
            "sha_claimable": True,
            "sha_intervention_code": "SHA-CT-016",
            "turnaround_hours": 24,
        },
        # ADDITIONAL MRI PROCEDURES
        {
            "code": "MRI-HIP",
            "name": "MRI Hip",
            "modality": "MRI",
            ...
            "cost": Decimal("20000.00"),
            "sha_claimable": True,
            "sha_intervention_code": "SHA-MRI-010",
            "turnaround_hours": 48,
        },
        {
            "code": "MRI-ANKLE",
            ...
            "cost": Decimal("18000.00"),
            "sha_claimable": True,
            "sha_intervention_code": "SHA-MRI-011",
            "turnaround_hours": 48,
        },
        {
            "code": "MRI-WRIST",
            ...
            "cost": Decimal("18000.00"),
            "sha_claimable": True,
            "sha_intervention_code": "SHA-MRI-012",
            "turnaround_hours": 48,
        },
        {
            "code": "MRI-MRCP",
            ...
            "cost": Decimal("22000.00"),
            "sha_claimable": True,
            "sha_intervention_code": "SHA-MRI-013",
            "turnaround_hours": 48,
            "special_preparation": "Fasting 4-6 hours required.",
        },
        {
            "code": "MRI-WHOLE-SPINE",
            "name": "MRI Whole Spine",
            "modality": "MRI",
            "body_region": "SPINE",
            "cost": Decimal("25000.00"),
            "sha_claimable": True,
            "sha_intervention_code": "SHA-MRI-014",
            "turnaround_hours": 48,
        },
        {
            "code": "MRI-BREAST",
            ...
            "cost": Decimal("22000.00"),
            "sha_claimable": True,
            "sha_intervention_code": "SHA-MRI-015",
            "requires_contrast": True,
            "turnaround_hours": 48,
            "special_preparation": "Schedule day 7-14 of menstrual cycle if premenopausal.",
        },
        # NUCLEAR MEDICINE PROCEDURES
        {
            ...
            "cost": Decimal("15000.00"),
            "sha_claimable": True,
            "sha_intervention_code": "SHA-NM-001",
            "turnaround_hours": 48,
            "special_preparation": "Injection 2-3 hours before scan. Drink plenty of water.",
        },
        {
            "code": "NM-THYROID-SCAN",
            "name": "Thyroid Scan and Uptake",
            "modality": "NM",
            "body_region": "NECK",
            "cost": Decimal("12000.00"),
            "sha_claimable": True,
            "sha_intervention_code": "SHA-NM-002",
            "turnaround_hours": 48,
            "special_preparation": "Stop thyroid medication as directed. No iodine-containing foods/contrast 4 weeks prior.",
        },
        {
            "code": "NM-RENAL-SCAN",
            "name": "Renal Scan (DTPA/MAG3)",
            "modality": "NM",
            "body_region": "ABDOMEN",
            "cost": Decimal("14000.00"),
            "sha_claimable": True,
            "sha_intervention_code": "SHA-NM-003",
            "turnaround_hours": 48,
            "special_preparation": "Hydrate well before scan. No diuretics on day of scan unless instructed.",
        },
    ]
