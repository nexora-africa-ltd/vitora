...
class SurveillanceAlertConsumer(AsyncJsonWebsocketConsumer):
    ...
    async def receive_json(self, content):
        ...
        logger.debug("Received surveillance WebSocket message: %s", message_type)
    ...
    async def _periodic_broadcast(self):
        ...
        while True:
            try:
                ...
                logger.error("Error in periodic surveillance broadcast: %s", e)
    ...
    async def _send_current_stats(self):
        ...
        try:
            ...
            logger.error("Error sending surveillance stats: %s", e)
