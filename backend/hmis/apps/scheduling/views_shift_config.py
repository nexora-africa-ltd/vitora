...
# ruff: noqa
"""
What this file is for: scheduling settings, shift type, and staff constraint viewsets.
How to use: imported by `hmis.apps.scheduling.views` compatibility shim.
Supported inputs/args: DRF permission/filter/viewset classes for scheduling configuration workflows.
"""
