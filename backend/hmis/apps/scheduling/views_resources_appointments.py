...
# ruff: noqa
"""
What this file is for: scheduling filters plus resource, schedule, and appointment viewsets.
How to use: imported by `hmis.apps.scheduling.views` compatibility shim.
Supported inputs/args: DRF filter/viewset classes for core scheduling CRUD and lifecycle actions.
"""
