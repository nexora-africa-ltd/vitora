...
CATEGORIES = [
    {"name": "Consultation", "code": "CONSULT", "description": "Outpatient and specialist consultations"},
    ...
    {"name": "Maternity", "code": "MAT", "description": "Antenatal, delivery, and postnatal services"},
    ...
    {"name": "Administrative", "code": "ADMIN", "description": "Registration, records, and administrative fees"},
    {"name": "Allied Health", "code": "ALLIED", "description": "Occupational therapy, nutrition, counselling"},
]
...
SERVICES = [
    ...
    {"category_code": "RAD", "name": "Obstetric Ultrasound", "code": "RAD-003", "price": Decimal("1500.00"), "sha_code": "SHA-RAD-003"},
    # --- Procedures ---
    {"category_code": "PROC", "name": "Wound Dressing (Minor)", "code": "PROC-001", "price": Decimal("500.00"), "sha_code": "SHA-PROC-001"},
    {"category_code": "PROC", "name": "Incision and Drainage", "code": "PROC-002", "price": Decimal("2000.00"), "sha_code": "SHA-PROC-002"},
    {"category_code": "PROC", "name": "Suturing (Minor)", "code": "PROC-003", "price": Decimal("1500.00"), "sha_code": "SHA-PROC-003"},
    {"category_code": "PROC", "name": "Circumcision", "code": "PROC-004", "price": Decimal("3000.00"), "sha_code": "SHA-PROC-004"},
    # --- Inpatient ---
    {"category_code": "IPD", "name": "General Ward Bed-Night", "code": "IPD-001", "price": Decimal("1500.00"), "sha_code": "SHA-IPD-001"},
    {"category_code": "IPD", "name": "Private Ward Bed-Night", "code": "IPD-002", "price": Decimal("4000.00"), "sha_code": "SHA-IPD-002"},
    {"category_code": "IPD", "name": "Admission Fee", "code": "IPD-003", "price": Decimal("500.00"), "sha_code": "SHA-IPD-003"},
    # --- Emergency ---
    {"category_code": "EMER", "name": "Emergency Triage", "code": "EMER-001", "price": Decimal("1000.00"), "sha_code": "SHA-EMER-001"},
    {"category_code": "EMER", "name": "Resuscitation", "code": "EMER-002", "price": Decimal("5000.00"), "sha_code": "SHA-EMER-002"},
    # --- Maternity ---
    {"category_code": "MAT", "name": "Antenatal Visit", "code": "MAT-001", "price": Decimal("500.00"), "sha_code": "SHA-MAT-001"},
    {"category_code": "MAT", "name": "Normal Delivery", "code": "MAT-002", "price": Decimal("10000.00"), "sha_code": "SHA-MAT-002"},
    {"category_code": "MAT", "name": "Caesarean Section", "code": "MAT-003", "price": Decimal("35000.00"), "sha_code": "SHA-MAT-003"},
    # --- Nursing ---
    {"category_code": "NURS", "name": "IV Cannulation", "code": "NURS-001", "price": Decimal("300.00"), "sha_code": "SHA-NURS-001"},
    {"category_code": "NURS", "name": "Catheterization", "code": "NURS-002", "price": Decimal("500.00"), "sha_code": "SHA-NURS-002"},
    {"category_code": "NURS", "name": "Injection (IM/SC)", "code": "NURS-003", "price": Decimal("200.00"), "sha_code": "SHA-NURS-003"},
    # --- Administrative ---
    {"category_code": "ADMIN", "name": "Registration Fee", "code": "ADMIN-001", "price": Decimal("100.00"), "sha_code": ""},
    {"category_code": "ADMIN", "name": "Medical Records Copy", "code": "ADMIN-002", "price": Decimal("200.00"), "sha_code": ""},
    {"category_code": "ADMIN", "name": "Medical Report", "code": "ADMIN-003", "price": Decimal("500.00"), "sha_code": ""},
]
    ...
    def handle(self, *args, **options):
        ...
        for cat_data in CATEGORIES:
            ...
            if existing:
                ...
                cat_created += 1
                self.stdout.write(self.style.SUCCESS(f"  Category: {cat_data['code']} — {cat_data['name']}"))
        ...
        for svc_data in SERVICES:
            ...
            if cat_code not in cat_map:
                self.stdout.write(self.style.WARNING(f"  Skipped {svc_data['code']}: category {cat_code} not found"))
                continue
            ...
            if existing:
                ...
                svc_created += 1
                self.stdout.write(self.style.SUCCESS(f"  Service: {svc_data['code']} — {svc_data['name']}"))
