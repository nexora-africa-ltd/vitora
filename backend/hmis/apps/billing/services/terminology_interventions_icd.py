...
# ruff: noqa
"""
What this file is for: intervention and ICD-11 terminology service mixin methods.
How to use: mixed into TerminologyService in split terminology core module.
Supported inputs/args: instance methods for intervention/ICD search and retrieval.
"""
