...
# ruff: noqa
"""
What this file is for: M-Pesa callbacks/queries, reports, and facility billing config endpoints.
How to use: imported by `hmis.apps.billing.views` compatibility shim.
Supported inputs/args: DRF viewsets for mobile money and reporting/config APIs.
"""
