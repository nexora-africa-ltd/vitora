...
# ruff: noqa
"""
What this file is for: document auto-attach and text/PDF rendering methods for SHA claims automation.
How to use: mixed into SHAClaimAutomationService in split SHA automation core module.
Supported inputs/args: classmethod helpers for rendering and attaching claim documents.
"""
