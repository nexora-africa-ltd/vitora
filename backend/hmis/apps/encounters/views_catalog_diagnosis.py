...
# ruff: noqa
"""
What this file is for: ICD10, treatment template, and diagnosis encounter viewsets.
How to use: imported by `hmis.apps.encounters.views` compatibility shim.
Supported inputs/args: DRF viewsets for diagnosis catalog and diagnosis CRUD workflows.
"""
