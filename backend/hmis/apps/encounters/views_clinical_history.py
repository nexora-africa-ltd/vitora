...
# ruff: noqa
"""
What this file is for: medication, SNOMED search, social history, and chronic history viewsets.
How to use: imported by `hmis.apps.encounters.views` compatibility shim.
Supported inputs/args: DRF viewsets/API views for clinical history and suggestion workflows.
"""
