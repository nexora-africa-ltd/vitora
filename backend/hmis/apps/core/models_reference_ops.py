...
"""
What this file is for: operational reference models for notifications, callbacks, idempotency, coding, and feature flags.
How to use: imported by `hmis.apps.core.models_reference` for model registration and compatibility.
Supported inputs/args: Django model fields/methods for shared operational and coding metadata.
"""
