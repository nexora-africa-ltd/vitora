...
# ruff: noqa
"""
What this file is for: shared helpers/constants for core dashboard view modules.
How to use: imported by split dashboard view modules and compatibility shim.
Supported inputs/args: helper functions for tenant resolution, scoping, and fallback handling.
"""
