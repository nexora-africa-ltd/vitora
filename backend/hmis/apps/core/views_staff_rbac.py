...
# ruff: noqa
"""
What this file is for: department, role, staff profile, org membership, and permissions-self endpoints.
How to use: imported by `hmis.apps.core.views` compatibility module for API route wiring.
Supported inputs/args: Django REST Framework viewsets/api views for RBAC and staff-management workflows.
"""
