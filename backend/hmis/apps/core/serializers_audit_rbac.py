...
# ruff: noqa
"""
What this file is for: permission, audit, frontend event, geography, and RBAC serializers.
How to use: imported by `hmis.apps.core.serializers` compatibility shim.
Supported inputs/args: DRF serializer classes for core audit/reference/RBAC payloads.
"""
