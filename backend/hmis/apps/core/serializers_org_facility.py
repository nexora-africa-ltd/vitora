...
# ruff: noqa
"""
What this file is for: subscription, organization, and facility serializers plus tier validation helpers.
How to use: imported by `hmis.apps.core.serializers` compatibility shim.
Supported inputs/args: DRF serializers/helper functions for org/facility API payloads.
"""
