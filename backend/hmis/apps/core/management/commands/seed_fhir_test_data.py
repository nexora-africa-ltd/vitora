...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write("  observation_results_laboratory_id:  (none - create lab results)")
        self.stdout.write("  observation_alcohol_use_id:         (none)")
        self.stdout.write("  observation_results_radiology_id:   (none)")
        self.stdout.write("  device_id:        (none)")
        self.stdout.write("")
