...
# ruff: noqa
"""
What this file is for: patient volume and revenue trend dashboard endpoints.
How to use: imported by `hmis.apps.core.dashboard_views` compatibility shim.
Supported inputs/args: DRF function views/helpers for trend analytics endpoints.
"""
