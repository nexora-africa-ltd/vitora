...
# ruff: noqa
"""
What this file is for: organization membership and DHIS2 configuration serializers.
How to use: imported by `hmis.apps.core.serializers` compatibility shim.
Supported inputs/args: DRF serializers for org membership and DHIS2 config APIs.
"""
