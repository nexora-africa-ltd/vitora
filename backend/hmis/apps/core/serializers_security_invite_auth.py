...
# ruff: noqa
"""
What this file is for: certificate/document, invitation, and authentication/setup serializers.
How to use: imported by `hmis.apps.core.serializers` compatibility shim.
Supported inputs/args: DRF serializers for security artifacts, invitations, and auth flows.
"""
