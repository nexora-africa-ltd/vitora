...
class FHIRMedicationStatementView(APIView):
    ...
    def get(self, request, pk: int) -> Response:
        ...
        try:
            prescription = Prescription.objects.select_related("patient", "encounter").get(pk=pk)
        ...
        fhir_resource = {
            ...
            "meta": {
                ...
                "lastUpdated": format_date(
                    ...
                    if hasattr(prescription, "updated_at")
                    else datetime.now()
                ),
            },
            ...
            "effectiveDateTime": format_date(
                prescription.created_at if hasattr(prescription, "created_at") else datetime.now()
            ),
            "dateAsserted": format_date(
                prescription.created_at if hasattr(prescription, "created_at") else datetime.now()
            ),
        }
