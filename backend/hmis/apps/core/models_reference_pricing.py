...
"""
What this file is for: subscription and pricing catalog models (plans, SKUs, bundles, quotes).
How to use: imported by `hmis.apps.core.models_reference` for model registration and compatibility.
Supported inputs/args: Django model fields/methods for plan and pricing configuration.
"""
