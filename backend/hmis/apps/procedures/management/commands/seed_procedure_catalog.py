...
INITIAL_PROCEDURES = [
    ...
    {
        "code": "PROC-MS-002",
        "name": "Foreign Body Removal (Skin)",
        "category": "MINOR",
        "body_system": "INTEGUMENTARY",
        "base_fee": 2000,
        "requires_anesthesia": True,
    ...
    {
        "code": "PROC-PV-002",
        "name": "Male Circumcision (Pediatric)",
        "category": "PREVENTIVE",
        "body_system": "REPRODUCTIVE",
        "base_fee": 3000,
        "risk_level": "MEDIUM",
    ...
    {
        "code": "PROC-DX-002",
        "name": "Paracentesis (Abdominal Tap)",
        "category": "DIAGNOSTIC",
        "body_system": "DIGESTIVE",
        "base_fee": 5000,
        "risk_level": "HIGH",
