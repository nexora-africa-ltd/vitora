...
export default function PharmacyScreen() {
  ...
  if (prescriptionsQuery.isLoading) {
    return (
      <ScreenContainer>
        <LoadingState message="Loading pharmacy queue..." />
      </ScreenContainer>
    );
  }
    ...
    <ScreenContainer>
      ...
      <SectionCard title="Dispensing queue" subtitle="Stock-aware dispensing starts from the open prescription list.">
        {prescriptions.length === 0 ? (
          <EmptyState title="No prescriptions yet" description="Create a prescription from an encounter or start one directly from the pharmacy module." />
        ) : (
