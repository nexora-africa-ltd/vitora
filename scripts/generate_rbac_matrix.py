...
ACTION_DESCRIPTIONS = {
    ...
    "inpatient.submit_interfacility_transfer": "Submit an inter-facility transfer request",
    "inpatient.accept_interfacility_transfer": "Accept an inter-facility transfer request",
    "inpatient.reject_interfacility_transfer": "Reject an inter-facility transfer request",
    "inpatient.dispatch_interfacility_transfer": "Dispatch patient for inter-facility transfer",
    "inpatient.arrive_interfacility_transfer": "Mark inter-facility transfer as arrived",
    "inpatient.cancel_interfacility_transfer": "Cancel an inter-facility transfer request",
