...
> Source: [https://hie-docs.dha.go.ke/docs/authentication/getting-started/intro](https://hie-docs.dha.go.ke/docs/authentication/getting-started/intro)
...
- [API Reference:](https://hie-docs.dha.go.ke/auth) Authentication endpoints and schemas in the [API Catalog](https://hie-docs.dha.go.ke/catalog).
